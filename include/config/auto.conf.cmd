...
ifneq "$(KERNELVERSION)" "6.14.0-openbase-src-custom"
$(autoconfig): FORCE
endif
...
ifneq "$(CC_VERSION_TEXT)" "gcc (Gentoo 14.2.1_p20241221 p7) 14.2.1 20241221"
$(autoconfig): FORCE
endif
...
ifneq "$(RUSTC_VERSION_TEXT)" "rustc 1.84.1 (e71f9a9a9 2025-01-27)"
$(autoconfig): FORCE
endif
